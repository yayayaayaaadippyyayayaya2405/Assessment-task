...
def open_quiz():
    ...
    options = [
        [("9 cubic units", "a1"), ("27 cubic units", "a2"), ("18 cubic units", "a3")],
        [("20π cubic units", "b1"), ("40π cubic units", "b2"), ("60π cubic units", "b3")],
        [("64π cubic units", "c1"), ("128π cubic units", "c2"), ("256π cubic units", "c3")],
        [("27π cubic units", "d1"), ("81π cubic units", "d2"), ("54π cubic units", "d3")],
        [("120 cubic units", "e1"), ("110 cubic units", "e2"), ("130 cubic units", "e3")],
        [("10 cubic units", "f1"), ("20 cubic units", "f2"), ("30 cubic units", "f3")],
        [("343 cubic units", "g1"), ("421 cubic units", "g2"), ("512 cubic units", "g3")],
        [("True", "h1"), ("False", "h2")],
        [("True", "i1"), ("False", "i2")],
        [("True", "j1"), ("False", "j2")],
        [("True", "k1"), ("False", "k2")],
