...
def open_Learn_window ():
    ...
    Volume_definition1 = CTkLabel(learn_window, text="Let's imagine you have a big box.",
                                  ...
                                  font=Text_font,
                                  wraplength=900,
                                  anchor="w")  #making the anchor "w" helps with make left-aligned text, whereas "e" would make it Right-aligned text 
...
def open_learn_window2 ():
    ...
    examples_window_tittle.place(x=20,y=10)
...
def open_quiz ():
    ...
    quiz_window_tittle = (CTkLabel(quiz_window, text=('Quiz Regarding Volume ;)'), 
                                  text_color="#4263F5",
                                  bg_color="#C1E1C1", 
                                  font = Title_font)
                                  )
    quiz_window_tittle.place(x=150,y=20)
